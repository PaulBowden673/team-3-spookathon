...
let quiz = {
    ...
    data: [{
      ...
      {
        q: `As you approach the door thunder crashes and rain starts pouring down, so you quickly stand under the porch.
    ...
    `,
      o: [
          `Do you go upstairs. The door leads out a secret bookcase at the top of the grand staircase. Suddenly footsteps can be heard coming from down the hall.`,
          `Do you go down the stairs, The stairs lead towards the basement.`,
      ],
      a: 1
    },
  {
...
hWrap: null, // HTML quiz container
  ...
  select: function () {
    ...
    if (correct) {
      ...
      window.location.reload("#hero").scrollTo(0,0);
    }
     else {
